...
export const updateLocationRules: CollectionRule[] = [
  ...
  },
  {
    ...
    target: "stores",
    mode: "fan-out",
    invariant: "Safety net — if a default location's name is written outside the transactional path, Eventarc cascades the name to the store's default_location",
